...
!(function (t, e) {
   ...
   var D = {
      init: function (t) {
         ...
         (D.supportsTouch =
            ...
            (D.supportsPointerEvent =
               !1 !== n.pointerEnabled && !!k.PointerEvent),
            (D.isIOS = /iP(hone|od|ad)/.test(n.platform)),
            (D.isIOS7 =
               /iP(hone|od|ad)/.test(n.platform) &&
               /OS 7[^\d]/.test(n.appVersion)),
            ...
            (D.pEventTypes = D.supportsPointerEvent
               ...
               : null),
            (D.wheelEvent =
               k.document && 'onmousewheel' in k.document
                  ? 'mousewheel'
                  : 'wheel');
      },
      supportsTouch: null,
                  ...
                  value: function () {
                     ...
                     if (
                        ...
                        if (
                           ...
                           this.dropzone.fire(
                              new n(e, this.dragEvent, 'dragleave')
                           );
                  },
               },
               { key: 'preventDefault', value: function () {} },
   ...
   function Et(t, e) {
      for (
         var n = (function (t, e) {
               for (
                  var n = [], r = 0, i = t.interactables.list;
                  r < i.length;
                  r++
               ) {
                  var o = i[r];
                  if (o.options.drop.enabled) {
                     ...
                     if (
                        !(
                           ...
                           (w.string(a) && !R(e, a)) ||
                           (w.func(a) &&
                              !a({ dropzone: o, draggableElement: e }))
                        )
                     )
                        for (
                           var s = 0, c = o.getAllElements();
                           s < c.length;
                           s++
                        ) {
                           var l = c[s];
                     ...
                     if (l !== a.ownerDocument)
                        if (c !== l) {
                           ...
                           (r = s),
                              ...
                              void 0,
                              (parseInt(
                                 y((n = a)).getComputedStyle(n).zIndex,
                                 10
                              ) || 0) >=
                                 (parseInt(
                                    y(r).getComputedStyle(r).zIndex,
                                    10
                                 ) || 0) && (e = o);
                     else e = o;
               } else e = o;
            ...
            t.usePlugin(_),
               (r.prototype.dropzone = function (t) {
                  return (function (t, e) {
                     if (w.object(e)) {
                        if (
                           ((t.options.drop.enabled = !1 !== e.enabled),
                           e.listeners)
                        ) {
                           var n = $(e.listeners),
                        ...
                        return (
                           ...
                           w.func(e.ondragenter) &&
                              t.on('dragenter', e.ondragenter),
                           w.func(e.ondragleave) &&
                           ...
                           'checker' in e &&
                              (t.options.drop.checker = e.checker),
                           t
                        );
                     }
                  ...
                  return (function (t, e, n, r, i, o, a) {
                     ...
                     if (d && w.number(c)) {
                        s =
                           (Math.max(
                              0,
                              Math.min(a.right, d.right) -
                                 Math.max(a.left, d.left)
                           ) *
                              Math.max(
                                 0,
                                 Math.min(a.bottom, d.bottom) -
                                    Math.max(a.top, d.top)
                              )) /
                              (d.width * d.height) >=
                           c;
                     }
               ...
               if (i) {
                  ...
                  if (
                     ...
                     if (w.object(s.edges)) {
                        ...
                        var u =
                              'y' !== s.axis &&
                              a.x > i.right - jt.defaultMargin,
                           p =
                              'x' !== s.axis &&
                              a.y > i.bottom - jt.defaultMargin;
                        (u || p) &&
                           (t.action = {
                              name: 'resize',
                              axes: (u ? 'x' : '') + (p ? 'y' : ''),
   ...
   var Lt = {
      ...
      init: function (t) {
         if (
            ((Rt = t.requestAnimationFrame), (Ct = t.cancelAnimationFrame), !Rt)
         )
            for (
               ...
               !(function (t, e) {
                  ...
                  (function (t, e) {
                     ...
                     if (
                        ...
                        i &&
                           r &&
                           (r.options[i].manualStart ||
                           !ee(r, n.element, n.prepared, e)
                              ? n.stop()
      ...
      listeners: {
         'autoStart:before-start': function (t, e) {
            ...
            if ('drag' === n.prepared.name) {
               ...
               if (
                  ((n.prepared.axis =
                     'start' === c.lockAxis ? u[0] : c.lockAxis),
                  'xy' !== u && 'xy' !== l && l !== u)
               ) {
         ...
         listeners: {
            ...
            'interactions:move': function (t) {
               ...
               e.autoStartHoldTimer &&
                  e.pointerWasMoved &&
                  !n &&
                  (clearTimeout(e.autoStartHoldTimer),
                  ...
                  value: function (t, e, n) {
                     ...
                     var r,
                        ...
                        o =
                           ...
                           this.coords.cur.client.x ===
                              this.coords.prev.client.x &&
                           this.coords.cur.client.y ===
                              this.coords.prev.client.y;
                     this.pointerIsDown &&
                        !this.pointerWasMoved &&
                        ((r =
                           this.coords.cur.client.x -
                           this.coords.start.client.x),
                        (i =
                           this.coords.cur.client.y -
                           this.coords.start.client.y),
                        (this.pointerWasMoved =
                           Q(r, i) > this.pointerMoveTolerance));
                     var a,
                        s,
                        c,
               ...
               },
               {
                  ...
                  value: function (t) {
                     ...
                     if (
                        (o &&
                           ...
                           (H(
                              ...
                              o,
                              this.coords.delta[
                                 this.interactable.options.deltaSource
                              ]
                           ),
                        ...
                        !1 ===
                           this._scopeFire(
                              'interactions:before-action-'.concat(n),
                              t
                           ))
                     )
                        return !1;
                     ...
                     return (
                        ...
                        this._fireEvent(a),
                        this._scopeFire(
                           'interactions:after-action-'.concat(n),
                           t
                        ),
                        !0
                     );
         ...
         o(t, [
            {
               ...
               value: function (t) {
                  ...
                  if (
                     ...
                     if (
                        ((o.result = o.setAll(this.modifierArg)),
                        !o.result.changed)
                     )
                        return !1;
                     this.startSmoothEnd();
               ...
               value: function () {
                  ...
                  if (u < this.te) {
                     var p,
                        f =
                           1 -
                           (Math.exp(-l * u) - this.lambda_v0) / this.one_ve_v0;
                     this.isModified
                        ? ((t = 0),
                          (e = 0),
            ...
            var e,
               ...
               o = {
                  ...
                  addDelegate: function (t, e, n, o, s) {
                     ...
                     h ||
                        ((h = { selector: t, context: e, listeners: [] }),
                        d.push(h));
                  ...
                  removeDelegate: function (t, e, n, i, o) {
                     ...
                     for (a = p.length - 1; a >= 0; a--) {
                        ...
                        if (d.selector === t && d.context === e) {
                           for (
                              var h = d.listeners, v = h.length - 1;
                              v >= 0;
                              v--
                           ) {
                              var g = h[v];
            ...
            o(t, [
               ...
               },
               {
                  ...
                  value: function (t) {
                     return (
                        (t =
                           t || (w.element(this.target) ? this.target : null)),
               ...
               },
               {
                  ...
                  value: function (t) {
                     return (
                        this._context === t.ownerDocument || M(this._context, t)
                     );
                  },
               },
               {
            ...
            (this.interactStatic = (function (t) {
               ...
               return (
                  ...
                  (e.pointerMoveTolerance = function (t) {
                     return w.number(t)
                        ? ((this.scope.interactions.pointerMoveTolerance = t),
                          this)
   ...
   var fn = Object.freeze({
            ...
            var e = [
               ...
               n = function (n, r) {
                  for (
                     ...
                     (l[f] = Math.max(
                        a.left,
                        Math.min(a.right, h * t[f] + c.x)
                     )),
                        (l[d] = Math.max(
                           a.top,
                           Math.min(a.bottom, v * t[d] + c.y)
                        ));
                  }
                  return l;
               };
      ...
      vn = {
         ...
         set: function (t) {
            ...
            if (
               (V(t.edges, o), s(n, n.xIsPrimaryAxis, i, r), !n.subModification)
            )
               return null;
            var c = V({}, r);
   ...
   var En = {
         ...
         set: function (t) {
            ...
            if (a) {
               ...
               (e.x = Math.max(
                  Math.min(s.right - o.right, e.x),
                  s.left + o.left
               )),
                  (e.y = Math.max(
                     Math.min(s.bottom - o.bottom, e.y),
                     s.top + o.top
                  ));
            }
         },
   ...
   function Pn(t, e) {
      for (
         var n = 0, r = ['top', 'left', 'bottom', 'right'];
         n < r.length;
         n++
      ) {
         var i = r[n];
               ...
               l = c.offsetWithOrigin
                  ? (function (t) {
                       var e = t.interaction.element,
                          ...
                          r =
                             n ||
                             K(t.interactable, e, t.interaction.prepared.name);
                       return r;
                    })(t)
                  : { x: 0, y: 0 };
